        ...
        const fetchData = async () => {
            try {
                const [statsRes, activityRes, projectsRes] = await Promise.all([
                    fetch(`${API_BASE_URL}/api/clients/${user.userId}/stats`),
                    fetch(`${API_BASE_URL}/api/clients/${user.userId}/recent-activity`),
                    fetch(`${API_BASE_URL}/api/clients/${user.userId}/active-projects`)
                ]);
